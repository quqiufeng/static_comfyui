// stable-diffusion-cli.cpp - SDXL txt2img using stable-diffusion.cpp C API
// Compile:
//   g++ -O3 -std=gnu++17 stable-diffusion-cli.cpp \
//     -I/opt/stable-diffusion.cpp/include -I/opt/stable-diffusion.cpp \
//     -L/opt/stable-diffusion.cpp/build -lstable-diffusion \
//     -L/opt/stable-diffusion.cpp/build/ggml/src -lggml -lggml-base -lggml-cpu \
//     -Wl,--whole-archive -lggml-cuda -Wl,--no-whole-archive \
//     -ldl -lpthread -lm -lgomp \
//     -L/data/cuda/targets/x86_64-linux/lib -lcudart -lcublas -lcublasLt -lcuda -lculibos \
//     -L/usr/lib -lz -ljpeg -lwebp \
...
int main(int argc, char** argv) {
    ...
    const char* output = "/tmp/sd_cli_output.png";
    ...
    fprintf(stderr, "stable-diffusion-cli\n");
    ...
    fprintf(stderr, "Saved %s (%dx%d)\n", output, images[0].width, images[0].height);
