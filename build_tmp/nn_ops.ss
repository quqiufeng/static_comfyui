...
(define (static_conv2d x w b n c_in c_out h w_in k_size stride pad)
  (begin
    ...
    (static_dgemm_row_auto _ncol c_out _kdim 1.0 _col w 0.0 _y)
    (set! _i 0)
...
(define (static_conv2d_transposed x w b n c_in c_out h w_in k_size stride pad out_h out_w)
  (begin
    ...
    (static_dgemm_row_auto n_cols k_dim c_out 1.0 x w_t 0.0 y_col)
...
(define (static_attention_sd q k v batch tokens_q tokens_k dim heads)
  (begin
    ...
    (static_dgemm_row_auto n_sim_rows tokens_k dim_head scale q_h k_h 0.0 sim)
    (set! r 0)
    ...
    (static_dgemm_row_auto n_sim_rows dim_head tokens_k 1.0 sim v_h 0.0 out_h)
...
(define (static_conv2d_inline src w b n c_in c_out hh ww)
  (begin
    ...
    (static_dgemm_row_auto _nc c_out _kd 1.0 _col w 0.0 _y)
    (set! _i 0)
