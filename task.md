...
| [ ] | **Flow Matching** | `model_sampling.py` | 431 | Flux/整流流 sigma 调度 — 后续 Phase 11 |
| [ ] | **采样辅助** | `sampler_helpers.py` | 262 | latent 准备, denoise mask — Phase 8 管线集成 |
