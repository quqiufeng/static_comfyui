#!/bin/bash
# scripts/gen_unet_sdpa.sh — 生成 SDPA attention 版本的 unet_forward.static.py
set -euo pipefail
...
cd "$ROOT"
python3 gen_unet.py "$INDEX" sdpa > sd_runtime/unet_forward.static.py
echo "Generated sd_runtime/unet_forward.static.py (SDPA attention)"
